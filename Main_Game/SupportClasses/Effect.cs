...
namespace Main_Game
{
    public class Effect
    {
        ...
        public uint mana_restore { get { return p_mana_restore; } set { p_mana_restore = value; } }
        ...
        public Effect(uint hr, uint mr, float stm, float am, float im, float spm)
        {
            p_health_restore = hr;
            p_mana_restore = mr;
            p_strength_mod = stm;
